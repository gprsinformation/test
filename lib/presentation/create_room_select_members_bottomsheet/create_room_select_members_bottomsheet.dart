import '../create_room_select_members_bottomsheet/widgets/listcheckmark_item_widget.dart';
...
class CreateRoomSelectMembersBottomsheet extends StatelessWidget {
  CreateRoomSelectMembersBottomsheet(this.controller);

  CreateRoomSelectMembersController controller;
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.createRoomSelectMembersModelObj.value
                        .listcheckmarkItemList.length,
                    itemBuilder: (context, index) {
                      ListcheckmarkItemModel model = controller
                          .createRoomSelectMembersModelObj
                          .value
