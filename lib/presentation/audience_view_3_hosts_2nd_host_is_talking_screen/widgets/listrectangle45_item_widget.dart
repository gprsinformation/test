...
class Listrectangle45ItemWidget extends StatelessWidget {
  Listrectangle45ItemWidget(this.listrectangle45ItemModelObj);

  Listrectangle45ItemModel listrectangle45ItemModelObj;
