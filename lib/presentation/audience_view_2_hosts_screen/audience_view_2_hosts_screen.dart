import '../audience_view_2_hosts_screen/widgets/listunsplashcj14_item_widget.dart';
...
class AudienceView2HostsScreen extends GetWidget<AudienceView2HostsController> {
  @override
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.audienceView2HostsModelObj.value
                        .listunsplashcj14ItemList.length,
                    itemBuilder: (context, index) {
                      Listunsplashcj14ItemModel model = controller
                          .audienceView2HostsModelObj
                          .value
                          .listunsplashcj14ItemList[index];
                      return Listunsplashcj14ItemWidget(
                        model,
                      );
                    },
                  ),
