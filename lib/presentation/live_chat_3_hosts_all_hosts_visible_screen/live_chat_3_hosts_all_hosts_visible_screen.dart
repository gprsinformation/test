import '../live_chat_3_hosts_all_hosts_visible_screen/widgets/listrectangle42_item_widget.dart';
...
class LiveChat3HostsAllHostsVisibleScreen
    extends GetWidget<LiveChat3HostsAllHostsVisibleController> {
  @override
                            ...
                            child: Obx(
                              () => ListView.separated(
                                ...
                                itemCount: controller
                                    .liveChat3HostsAllHostsVisibleModelObj
                                    .value
                                ...
                                itemBuilder: (context, index) {
                                  Listrectangle42ItemModel model = controller
                                      .liveChat3HostsAllHostsVisibleModelObj
                                      .value
                                      .listrectangle42ItemList[index];
                                  return Listrectangle42ItemWidget(
                                    model,
                                  );
                                },
                              ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              CustomImageView(
                                imagePath: ImageConstant.imgRectangle41901,
                                height: getVerticalSize(
                                  136,
                                ),
                                width: getHorizontalSize(
                        ...
                        Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              CustomImageView(
                                imagePath: ImageConstant.imgRectangle41902,
                                height: getVerticalSize(
                                  136,
                                ),
                                width: getHorizontalSize(
