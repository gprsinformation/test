...
import '../models/cash_out_one_item_model.dart';
import 'package:flutter/material.dart';
import 'package:green_house/core/app_export.dart';
import 'package:green_house/widgets/custom_icon_button.dart';

// ignore: must_be_immutable
class CashOutOneItemWidget extends StatelessWidget {
  CashOutOneItemWidget(this.cashOutOneItemModelObj);

  CashOutOneItemModel cashOutOneItemModelObj;

  var controller = Get.find<CashOutOneController>();
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Obx(
                        () => Text(
                          cashOutOneItemModelObj.cardtypeTxt.value,
                      ...
                      Padding(
                        ...
                        child: Obx(
                          () => Text(
                            cashOutOneItemModelObj.cardnumberTxt.value,
                            overflow: TextOverflow.ellipsis,
                            textAlign: TextAlign.left,
