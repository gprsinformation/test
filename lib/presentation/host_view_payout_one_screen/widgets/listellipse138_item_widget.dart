...
class Listellipse138ItemWidget extends StatelessWidget {
  Listellipse138ItemWidget(this.listellipse138ItemModelObj);

  Listellipse138ItemModel listellipse138ItemModelObj;

  var controller = Get.find<HostViewPayoutOneController>();
